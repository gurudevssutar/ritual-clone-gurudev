  ...
  return (
    ...
    <SideDrawer show={drawerIsOpen} onClick={closeDrawer}>
        <div className="sdbase">
          <nav >
            <Link className="sdlinks" to="/multi-vitamin">Multivitamin</Link><br/>
            <Link className="sdlinks" to="/protein">Protein</Link><br/>
            <Link className="sdlinks" to="/pregnancy">Pregnancy</Link><br/>
            <Link className="sdlinks" to="/bundles">Bundles</Link><br/><br/>
